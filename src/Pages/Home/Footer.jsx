  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/logo.png" alt="Raghul" />
        </div>
            ...
            <li>
              ...
              >
                ...
                height="32"
                 viewBox="0 0 24 24" 
                 fill="none">
               <path d="M12 0C5.37 0 0 5.37 0 12c0 6.63 5.37 12 12 12s12-5.37 12-12c0-6.63-5.37-12-12-12zm5.998 12.52c0 1.782-.738 3.375-1.932 4.547H15.46c-1.214-1.214-1.854-2.764-1.854-4.547V7.186h3.393v5.334h.002zm-8.394-1.201h3.393v-2.024H8.604v2.024zm0 3.67h3.393v-2.023H8.604v2.023zm6.787-3.67h3.394V8.604h-3.394v5.335z"
               fill="currentColor"/>
               </svg>    
              </a>
            </li>
      ...
      <div className="footer--link--container">
        <div>
          <h2> AboutMe</h2><br/>
          <p className="hero--section-footers">
             I like front-end development specializing in Web development, Mobile Development.and<br/>
             Ui/Ux designing As a fresher in the tech world, I bring Creativity proficanal designing<br/> 
             in the User interaction.I am flexible and open to learning from mentors and leaders in the field
          </p>
        </div>
        <div className="footer--items">
          <ul>
      ...
      <div className="footer--content--container">
        <p className="footer--content">Profile created by RAGHUL....!</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
